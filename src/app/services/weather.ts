...
export class WeatherService {
  ...
  private weatherDataCache = new BehaviorSubject<any[]>([]);
  ...
  districtData$ = this.districtFeaturesSubject.asObservable();

  weatherDataCache$ = this.weatherDataCache.asObservable();
  

  // Method to update weather data cache
  setWeatherDataCache( data: any) {
    this.weatherDataCache.next(data);
  }

  // Method to set district data
  setDistrictData(districts: any) {
    this.districtFeaturesSubject.next(districts);
  }
